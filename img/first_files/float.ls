...
_ZLDSCREENNAME="windexinfotech"; //No I18N
_ZLDEMBEDNAME="windexinfotech";  //No I18N
...
function ZloadFiles()
{
  ...
  ocss.rel ="stylesheet";
  ocss.href = "https://css.zohostatic.com/salesiq/Jan_09_2017_https/styles/floatsupportbtn.css";  
  ...
  try
  {
		...
		if(ie && document.compatMode!="CSS1Compat")
		{
				var ocss = document.createElement("link");
				ocss.rel ="stylesheet";
				ocss.href = "https://css.zohostatic.com/salesiq/Jan_09_2017_https/styles/floatiebtnfix.css";  
				headArr[0].appendChild(ocss);
		}
  ...
  oscript.src="https://js.zohostatic.com/salesiq/Jan_09_2017_https/js/track.js";  //No I18N
  headArr[0].appendChild(oscript);//No I18N
}
...
function ZaddEvent()
{
  	...
  	var iframeurl = "https://salesiq.zohopublic.com/windexinfotech/drawchat.ls?";  	
    var _zldcpage = "https://windexinfotech.in/website-design/"; 
  ...
  _ZSIQ.initSIQAPI = _ZSIQ.initSIQAPI || function()   //No I18N
  {
    ...
    var floatcookie = readCookie('zld171702000000002043float');//No I18N
  ...
  _ZSIQ.initFloat = function()//No I18N
  {
	Float.newembed = false;//No I18N
        ...
        Float.lsobject={"autochat":"false","clickchat":"false","name":"","email":"","ques":"","department":"","embedname":"windexinfotech","lsid":"171702000000002043","bgcolor":"","oncontent":"settings.embed.offline","icon":"7","buttontheme":"red-btn","oncontentcolor":"","status":"off","statustext":"Offline","serverurl":"https://salesiq.zohopublic.com","url":"https://salesiq.zohopublic.com/windexinfotech/drawchat.ls?","floatposition":"bottomleft","top":"0","bottom":"0","left":"0","right":"0","flipicon":"false","aligntoright":"false","floatmeasurement":"px","headercolor":"","sbicobg":"","fltsize":"small","mobileoncontent":"common.mobile.chat","ipadoncontent":"infomsg.mobile.chatwithus","mobileoffcontent":"infomsg.mobile.offline"}; 
        Float.lsobject["imgurl"] = "https://img.zohostatic.com/salesiq/Jan_09_2017_https";  
		...
		Float.lsobject["screenname"]="windexinfotech" ;
		...
		Float.lsobject["float_fkey"]="0_171702000000002043";
		Float.lsobject["css_fkey"]="0_171702000000002043";
		Float.lsobject.themeid = ""	; //No I18N
   		Float.lsobject.embedtheme="red"; //NO I18N
